...
| Rank | Format | Level | Size | Ratio | Compress | Decompress | Notes |
|---:|---|---|---:|---:|---:|---:|---|
| 1 | paq8px (context mixing, state of the art) | default | 1.99 MB | 18.04% | 15.2m | 15.2m |  |
| 2 | zpaq (journaling PAQ-family) | max | 2.19 MB | 19.85% | 26.8 | 27.9 |  |
| 3 | tar.bz3 (bzip3) | default | 2.42 MB | 21.96% | 1.17 | 0.65 |  |
| 4 | tar.bz3 (bzip3) | max | 2.42 MB | 21.96% | 1.54 | 0.84 |  |
| 5 | tar.bz2 (bzip2) | default | 2.85 MB | 25.81% | 0.58 | 0.21 |  |
| 6 | tar.rz (rzip) | default | 2.91 MB | 26.42% | 0.73 | 0.30 |  |
| 7 | tar.rz (rzip) | max | 2.92 MB | 26.50% | 1.06 | 0.32 |  |
| 8 | tar.lz (lzip) | max | 2.96 MB | 26.89% | 3.84 | 0.22 |  |
| 9 | tar.xz (xz/LZMA2) | max | 2.97 MB | 26.92% | 3.50 | 0.13 |  |
| 10 | tar.xz (xz/LZMA2) | default | 2.97 MB | 26.92% | 3.23 | 0.12 |  |
| 11 | 7z (7-Zip, LZMA2) | max | 2.97 MB | 26.93% | 2.00 | 0.09 |  |
| 12 | tar.lz (lzip) | default | 2.97 MB | 26.98% | 3.59 | 0.22 |  |
| 13 | 7z (7-Zip, LZMA2) | default | 2.98 MB | 27.03% | 1.96 | 0.09 |  |
| 14 | tar.br (Brotli) | default | 2.98 MB | 27.05% | 13.5 | 0.04 |  |
| 15 | tar.lrz (lrzip) | default | 3.00 MB | 27.24% | 2.45 | 0.23 |  |
| 16 | tar.lrz (lrzip) | max | 3.00 MB | 27.24% | 2.66 | 0.23 |  |
| 17 | tar.zst (Zstandard) | max | 3.03 MB | 27.48% | 3.03 | 0.02 |  |
| 18 | RAR 4 (legacy format) | max | 3.25 MB | 29.45% | 0.27 | 0.06 |  |
| 19 | RAR 5 (WinRAR/rar) | max | 3.25 MB | 29.48% | 0.27 | 0.04 |  |
| 20 | DMG (ULMO, lzma-compressed image) | default | 3.28 MB | 29.75% | 7.07 | 0.36 |  |
| 21 | RAR 4 (legacy format) | default | 3.30 MB | 29.92% | 0.18 | 0.06 |  |
| 22 | RAR 5 (WinRAR/rar) | default | 3.30 MB | 29.95% | 0.17 | 0.05 |  |
| 23 | tar.gz (zopfli, exhaustive deflate) | default | 3.66 MB | 33.20% | 14.6 | 0.03 |  |
| 24 | LHA/LZH (1988, lh5) | max | 3.73 MB | 33.84% | 1.12 | 0.14 |  |
| 25 | tar.zst (Zstandard) | default | 3.80 MB | 34.48% | 0.04 | 0.02 |  |
| 26 | ZIP (Info-ZIP) | max | 3.85 MB | 34.92% | 0.54 | 0.07 |  |
| 27 | ZIP (PKZIP 2.04g, 1993) (emu) | max | 3.85 MB | 34.95% | — | — | emulated (size only) |
| 28 | tar.gz (gzip) | max | 3.85 MB | 34.96% | 0.53 | 0.04 |  |
| 29 | xar (macOS eXtensible ARchiver) | default | 3.85 MB | 34.96% | 0.56 | 0.04 |  |
| 30 | dar (Disk ARchive) | default | 3.85 MB | 34.96% | 0.59 | 0.05 |  |
| 31 | HA (1993, PPM-family) | default | 3.86 MB | 34.99% | 0.81 | 0.35 |  |
| 32 | ZIP (Info-ZIP) | default | 3.87 MB | 35.14% | 0.41 | 0.09 |  |
| 33 | tar.gz (gzip) | default | 3.88 MB | 35.18% | 0.40 | 0.04 |  |
| 34 | ZIP (PKZIP 2.04g, 1993) (emu) | default | 3.92 MB | 35.52% | — | — | emulated (size only) |
| 35 | Apple Archive (.aar, lzfse) | default | 3.93 MB | 35.66% | 0.06 | 0.04 |  |
| 36 | ARJ (1991) | max | 3.94 MB | 35.75% | 0.52 | 0.15 |  |
| 37 | ARJ (1991) | default | 3.94 MB | 35.77% | 0.47 | 0.16 |  |
| 38 | SquashFS (mksquashfs) | default | 3.96 MB | 35.89% | 0.08 | 0.03 |  |
| 39 | DMG (UDZO, zlib-compressed image) | max | 4.01 MB | 36.35% | 6.07 | 0.22 |  |
| 40 | WIM (wimlib, LZX) | max | 4.01 MB | 36.38% | 0.20 | 0.05 |  |
| 41 | WIM (wimlib, LZX) | default | 4.03 MB | 36.53% | 0.13 | 0.05 |  |
| 42 | zpaq (journaling PAQ-family) | default | 4.03 MB | 36.59% | 0.32 | 1.18 |  |
| 43 | LHA/LZH (1988, lh5) | default | 4.19 MB | 38.02% | 0.45 | 0.16 |  |
| 44 | zoo (1986) | max | 4.21 MB | 38.15% | 0.73 | 0.23 |  |
| 45 | freeze (1993) | default | 4.23 MB | 38.35% | 0.58 | 0.22 |  |
| 46 | CAB (gcab, MSZIP) | default | 4.25 MB | 38.55% | 0.32 | 0.05 |  |
| 47 | tar.Z (compress, LZW 1984) | default | 4.30 MB | 39.03% | 0.17 | 0.09 |  |
| 48 | tar.lz4 (LZ4) | max | 4.44 MB | 40.26% | 0.28 | 0.03 |  |
| 49 | tar.lzo (lzop) | max | 4.50 MB | 40.80% | 1.46 | 0.03 |  |
| 50 | DMG (UDZO, zlib-compressed image) | default | 4.79 MB | 43.44% | 4.08 | 0.23 |  |
| 51 | zoo (1986) | default | 5.17 MB | 46.93% | 0.25 | 0.09 |  |
| 52 | ARC (SEA, 1985) | default | 5.53 MB | 50.12% | 0.20 | 0.12 |  |
| 53 | tar.lzo (lzop) | default | 6.23 MB | 56.53% | 0.05 | 0.05 |  |
| 54 | tar.lz4 (LZ4) | default | 6.40 MB | 58.09% | 0.02 | 0.02 |  |
| 55 | cpio (appendix: store-only) | default | 11.02 MB | 100.01% | 0.07 | 0.02 |  |
| 56 | tar (uncompressed, baseline) | default | 11.03 MB | 100.04% | 0.03 | 0.03 |  |
| 57 | pax (appendix: POSIX archiver) | default | 11.04 MB | 100.10% | 0.04 | 0.04 |  |
| 58 | ar (appendix: unix archiver, store-only) | default | 11.04 MB | 100.10% | 0.07 | 0.04 |  |
| 59 | shar (appendix: shell archive) | default | 11.29 MB | 102.40% | 0.13 | 0.18 |  |
| 60 | ISO 9660 (mkisofs, store-only) | default | 11.38 MB | 103.24% | 0.03 | 0.01 |  |


### Best format per content category

| Category | Smallest format | Ratio | Practical winner (mainstream) |
|---|---|---:|---|
| Text | paq8px (context mixing, state of the art) (default) | 18.04% | tar.xz (xz/LZMA2) — 26.92% |
